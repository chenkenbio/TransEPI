...
bengi_train="../data/BENGI.GM12878.CTCF-ChIAPET-Benchmark.v3.targetfinder_features.tsv ../data/BENGI.GM12878.HiC-Benchmark.v3.targetfinder_features.tsv ../data/BENGI.GM12878.RNAPII-ChIAPET-Benchmark.v3.targetfinder_features.tsv ../data/BENGI.HeLa.CTCF-ChIAPET-Benchmark.v3.targetfinder_features.tsv ../data/BENGI.HeLa.HiC-Benchmark.v3.targetfinder_features.tsv ../data/BENGI.HeLa.RNAPII-ChIAPET-Benchmark.v3.targetfinder_features.tsv" #"../data/BENGI.IMR90.HiC-Benchmark.v3.targetfinder_features.tsv ../data/BENGI.K562.HiC-Benchmark.v3.targetfinder_features.tsv ../data/BENGI.NHEK.HiC-Benchmark.v3.targetfinder_features.tsv"
